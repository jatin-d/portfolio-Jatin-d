    ...
    return(
        <BounceInRight className="experience-description-wrapper" delay={2}>
            <div >
                ...
                <p className='experience-text'><b><em>Adaptability – </em></b> By travelling across the world, living in diverse locations, and forming new friendships, I learned to adept with culture, language, values, business conduct laws, and traditions.</p> 
                ...
                <p className='experience-text'><b><em>Critical thinking & problem solving skills – </em></b> Going through changes, I encountered situations without clear resolutions. I called upon my critical thinking, problem solving, logical skills and creativity in order to find solutions.</p>
                <Flash className='experience-instruction experience-text'>
                    <p className='experience-instruction-text'><i class="far fa-arrow-alt-circle-left"></i> Click tabs to know more about my professional experience </p>
                </Flash> 
            </div>     
        </BounceInRight> 
    ) 
